#!/bin/bash
#SBATCH --job-name=wangxiangyi_8b_5_fval
#SBATCH --output=slurm_logs/instruction_brain_8b_5_fval/%j_%x.out
#SBATCH --error=slurm_logs/instruction_brain_8b_5_fval/%j_%x.err
...
python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=DPed_brain_new/fast_eval/instruction_4a_rlv1_8_brain_qwen3_vl_8b_5_fast_eval.yaml
