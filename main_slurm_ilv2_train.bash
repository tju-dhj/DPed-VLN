#!/bin/bash
#SBATCH --job-name=il_v2
#SBATCH --output=slurm_logs/il_v2/%j_%x.out
#SBATCH --error=slurm_logs/il_v2/%j_%x.err
#SBATCH --wckey=p14004
#SBATCH -A p_p14004
#SBATCH -p L40
...
python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=dynamic_vlnce/dynamic_vlnce_hm3d_direct_il_train_v2.yaml