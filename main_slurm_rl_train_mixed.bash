#!/bin/bash
#SBATCH --job-name=rl_v3
#SBATCH --output=slurm_logs/rl_v3/%j_%x.out
#SBATCH --error=slurm_logs/rl_v3/%j_%x.err
#SBATCH --wckey=p14004
#SBATCH -A p_p14004
#SBATCH -p A800
...
python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=dynamic_vlnce/dynamic_vlnce_hm3d_train_v1v2_mixed.yaml