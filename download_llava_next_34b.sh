#!/bin/bash
# ==============================================================================
# 文件: download_llava_next_34b.sh
# 描述: 下载 LLaVA-NeXT-34B 模型（大模型，约 68GB）
# ==============================================================================

SAVE_DIR="/share/home/u19666033/dhj/DPed_pro/pretrained_model"
mkdir -p "${SAVE_DIR}"

MODEL_ID="llava-hf/llava-next-34b-hf"
MODEL_NAME="llava-next-34b-hf"
...
echo ""
echo -e "${BLUE}============================================${NC}"
echo -e "${BLUE}  LLaVA-NeXT-34B 模型下载${NC}"
echo -e "${BLUE}============================================${NC}"
echo ""
echo -e "模型ID: ${GREEN}${MODEL_ID}${NC}"
echo -e "保存路径: ${GREEN}${MODEL_PATH}${NC}"
echo ""
echo -e "${YELLOW}警告: 此模型约 68GB，下载时间较长，请确保磁盘空间充足${NC}"
echo ""
...
echo ""
echo -e "${YELLOW}开始下载（首次运行可能需要 1-3 小时，取决于网络）...${NC}"
echo ""
