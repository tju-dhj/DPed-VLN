#!/bin/bash
#SBATCH --job-name=navila_v2
#SBATCH --output=slurm_logs/navila_v2/%j_%x.out
#SBATCH --error=slurm_logs/navila_v2/%j_%x.err
#SBATCH --wckey=p14004
#SBATCH -A p_p14004
#SBATCH -p L40
...
python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=dynamic_vlnce/navila_falcon_hm3d_v2.yaml