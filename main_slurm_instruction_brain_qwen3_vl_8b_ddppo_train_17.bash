...
#SBATCH --output=slurm_logs/instruction_brain_ddppo_17/%j_%x.out
#SBATCH --error=slurm_logs/instruction_brain_ddppo_17/%j_%x.err
...
srun --unbuffered \
  ...
  --config-name=DPed_brain_new/instruction_4a_rlv1_17_brain_qwen3_vl_8b_ddppo_train.yaml
