#!/bin/bash
#SBATCH --job-name=wangxiangyi_2b_14_fval
#SBATCH --output=slurm_logs/instruction_brain_2b_14_fval/%j_%x.out
#SBATCH --error=slurm_logs/instruction_brain_2b_14_fval/%j_%x.err
...
python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=DPed_pro/new_data/eval/dped_eval_4a_start_eval_fast_debug.yaml
