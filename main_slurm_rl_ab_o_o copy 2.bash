#!/bin/bash
#SBATCH --job-name=rl_ab_o_o
#SBATCH --output=slurm_logs/rl_ab_o_o/%j_%x.out
#SBATCH --error=slurm_logs/rl_ab_o_o/%j_%x.err
#SBATCH --wckey=p14004
#SBATCH -A p_p14004
#SBATCH -p L40
...
python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=dynamic_vlnce/ablation/dynamic_vlnce_rl_val_ab_o_o.yaml