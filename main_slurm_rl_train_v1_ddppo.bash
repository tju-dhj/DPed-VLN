#!/bin/bash
#SBATCH --job-name=wxy_rl_v1_ddppo
#SBATCH --output=slurm_logs/rl-v1-ddppo/%j_%x.out
#SBATCH --error=slurm_logs/rl-v1-ddppo/%j_%x.err
...
srun --unbuffered \
  ...
  --config-name=dynamic_vlnce_ddppo/dynamic_vlnce_ddppo_hm3d_train_v1_ddppo.yaml
