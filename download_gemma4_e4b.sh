#!/bin/bash
# ==============================================================================
# 文件: download_gemma4_e4b.sh
# 描述: 下载 Gemma-4-E4B 模型（轻量级，约 8GB）
# ==============================================================================
...
echo ""
echo -e "${BLUE}============================================${NC}"
echo -e "${BLUE}  Gemma-4-E4B 模型下载 (ModelScope)${NC}"
echo -e "${BLUE}============================================${NC}"
echo ""
...
export MODELSCOPE_CACHE="${SAVE_DIR}/modelscope_cache"
...
print("Downloading ${MODEL_ID} from ModelScope...", flush=True)
...
try:
    ...
    shutil.copytree(save_path, "${MODEL_PATH}")
    print("Successfully downloaded to: " + str("${MODEL_PATH}"), flush=True)
