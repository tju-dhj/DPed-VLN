#!/bin/bash
#SBATCH --job-name=wangxiangyi_il_train
#SBATCH --output=slurm_logs/il_train/%j_%x.out
#SBATCH --error=slurm_logs/il_train/%j_%x.err
...
python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=DPed_pro/new_data/IL/il_train.yaml
