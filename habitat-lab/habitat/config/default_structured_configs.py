...
class InstructionSensorConfig(LabSensorConfig):
    type: str = "FalconInstructionSensor"


@dataclass
class GT_ActionSensorConfig(LabSensorConfig):
    type: str = "FalconGTActionSensor"

@dataclass
class StartingPointGpsCompassSensorConfig(LabSensorConfig):
    type: str = "FalconStartingPointGpsCompassSensor"
...
@dataclass
class OverheadFrontRGBSensorConfig(HabitatSimRGBSensorConfig):
    uuid: str = "overhead_front_rgb"
    width: int = 256
    height: int = 256

@dataclass
class OverheadFrontDepthSensorConfig(HabitatSimDepthSensorConfig):
    uuid: str = "overhead_front_depth"
    width: int = 256
    height: int = 256
...
cs.store(
    group="habitat/simulator/sim_sensors",
    name="overhead_front_rgb_sensor",
    node=OverheadFrontRGBSensorConfig,
)

cs.store(
    group="habitat/simulator/sim_sensors",
    name="overhead_front_depth_sensor",
    node=OverheadFrontDepthSensorConfig,
)
...
cs.store(
    ...
    group="habitat/task/lab_sensors",
    name="falcon_instruction_sensor",
    node=InstructionSensorConfig,
)
cs.store(
    package="habitat.task.lab_sensors.gt_action_sensor",
    group="habitat/task/lab_sensors",
    name="falcon_gt_action_sensor",
    node=GT_ActionSensorConfig,
)
cs.store(
    package="habitat.task.lab_sensors.starting_point_gps_compass_sensor",
    group="habitat/task/lab_sensors",
    name="starting_point_gps_compass_sensor",
    node=StartingPointGpsCompassSensorConfig,
)
cs.store(
