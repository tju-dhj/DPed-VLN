...
class ArticulatedAgentManager:
    ...
    def __init__(self, cfg, sim):
        ...
        for agent_name in cfg.agents_order:
            ...
            if agent_cfg.articulated_agent_type != None:
                ...
                if len(cfg.agents) > 1 and "third" in agent._cameras and agent_name != "agent_0":
                    agent._cameras.pop('third') # do not use third_rgb of other agents
                    
                    # Prefix sensors if there is more than 1 agent in the scene.
                    # not use the agent prefix
