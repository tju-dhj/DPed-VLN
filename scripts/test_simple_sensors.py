...
from falcon.vln_sensors import InstructionSensor, GT_ActionSensor


def test_simple_sensors():
    """测试简化的传感器"""
    ...
    gt_action_sensor = GT_ActionSensor()
    ...
    mock_episode = type('MockEpisode', (), {
        ...
        'gt_action': [1, 1, 1, 2, 1, 1, 0, 1, 2, 1, 1, 1, 0],
    })()
