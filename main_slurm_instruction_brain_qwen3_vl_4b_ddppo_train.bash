#!/bin/bash
#SBATCH --job-name=wangxiangyi_4b_ib
#SBATCH --output=slurm_logs/instruction_brain_ddppo_4b/%j_%x.out
#SBATCH --error=slurm_logs/instruction_brain_ddppo_4b/%j_%x.err
...
srun --unbuffered \
  ...
  --config-name=DPed_brain_new/instruction_4a_rlv1_8_brain_qwen3_vl_4b_ddppo_train.yaml
