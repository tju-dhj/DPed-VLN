#!/bin/bash
#SBATCH --job-name=dhj_grpo_eval
#SBATCH --output=slurm_logs/grpo_eval/%j_%x.out
#SBATCH --error=slurm_logs/grpo_eval/%j_%x.err
...
mkdir -p slurm_logs/grpo_eval

python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=DPed_pro/new_data/eval/dped_eval_4a_grpo_from_il_aligned_full_eval_fast.yaml \
  "$@"
