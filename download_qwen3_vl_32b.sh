#!/bin/bash
# ==============================================================================
# 文件: download_qwen3_vl_32b.sh
# 描述: 下载 Qwen3-VL-32B 模型（大模型，约 64GB）
# ==============================================================================
...
echo ""
echo -e "${BLUE}============================================${NC}"
echo -e "${BLUE}  Qwen3-VL-32B-Instruct 模型下载${NC}"
echo -e "${BLUE}============================================${NC}"
echo ""
echo -e "模型ID: ${GREEN}${MODEL_ID}${NC}"
echo -e "保存路径: ${GREEN}${MODEL_PATH}${NC}"
echo ""
echo -e "${YELLOW}警告: 此模型约 64GB，下载时间较长，请确保磁盘空间充足${NC}"
echo ""
...
echo ""
echo -e "${YELLOW}开始下载（首次运行可能需要 1-4 小时，取决于网络）...${NC}"
echo ""
