#!/bin/bash
#SBATCH --job-name=dped_rl_train_v1_ddppo
#SBATCH --output=slurm_logs/dped/starting_gps/%j_%x.out
#SBATCH --error=slurm_logs/dped/starting_gps/%j_%x.err
...
srun --unbuffered \
  ...
  --config-name=DPed/dped_train_v1_ddppo.yaml
