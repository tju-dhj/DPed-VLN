...
def parse_args():
    ...
    parser.add_argument(
        "--pred_path",
        type=str,
        default="/lustre/fsw/portfolios/nvr/users/yukangc/VILA-Internal-main-3/runs/eval/Gemini/pred2.json",
    ...
    parser.add_argument(
        "--video_dir",
        type=str,
        default="/lustre/fsw/portfolios/nvr/users/yukangc/download_videos/short_videos_eval",
