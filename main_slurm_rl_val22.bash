#!/bin/bash
#SBATCH --job-name=rl_v22
#SBATCH --output=slurm_logs/rl_v22/%j_%x.out
#SBATCH --error=slurm_logs/rl_v22/%j_%x.err
#SBATCH --wckey=p14004
#SBATCH -A p_p14004
#SBATCH -p L40
...
python -u -m habitat-baselines.habitat_baselines.run \
  --config-name=dynamic_vlnce/dynamic_vlnce_hm3d_rl_val_v22.yaml